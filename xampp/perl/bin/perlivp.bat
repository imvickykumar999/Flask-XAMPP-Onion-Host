...
#!perl
#line 29
    eval 'exec C:\Users\Vicky\Desktop\Repository\Host-Onion\xampp\perl\bin\perl.exe -S $0 ${1+"$@"}'
...
my $perlpath = 'C:\Users\Vicky\Desktop\Repository\Host-Onion\xampp\perl\bin\perl.exe';
